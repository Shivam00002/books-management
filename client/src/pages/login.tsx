...
const Login: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>Log In | Book Management</title>
        <meta
          name="description"
          content="Log in to access your Book Management account. Manage your notes with ease and enjoy 30 days of free trial."
        />
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <div>
              <input
                ...
                className="w-full text-gray-600 dark:text-black px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
